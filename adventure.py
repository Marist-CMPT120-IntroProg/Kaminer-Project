...
cmountain = "One path on the left leading towards a beach and another drops down with a pair of skis at the top."
...
temple = "Inside the temple it is overgrown with coral, sharks darting in and out of the columns that look like they are about to fall any second."
...
cliff = "After grabbing the treasure, you look around and see a rope ladder on the side of the mountain. You climb up the ladder to the top of the cliff, in the distance you see the area where you started."
...
slope = "Going past where you started, you hop on the skis and start to descend clutching the treasure."
...
lift = "Once at the base of the chairlift, you see rust forming along the chairs."
clift = "Upon a closer look you see that the door to the controls is open and spot a keyhole, using the key you found at the cliff, you slowly turn it and hear the ski lift start to turn on and creak alive."
lodge ="Stopping right before the parking lot, you enter an old ski lodge."
clodge = "Once inside you see cans of food and mice scurrying around. Trays and utensils are strewn everywhere, as if people left in a hurry. You grab some closed cans of food and continue on skis down towards the parking lot."
