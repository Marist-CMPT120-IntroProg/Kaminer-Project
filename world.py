...
s_mountain = "\nYou slowly open your eyes and look around, all you see is clouds."
...
e_ocean = "\nTaking a moment to stop and glance around underwater, you see beatiful coral all around almost as if the ocean is glowing.\nFish dart in and out of the coral, you notice some sharks in the distance."
...
e_slope = "\nThrough the bottom of the clouds you see the sun beating down on the snow covered landscape and you spot a chairlift in the distance.\nBeyond that you see the sun glinting off multiple cars in a parking lot"
s_lift = "\nArriving at the base of the chairlift, you can see rust covering the chairs."
e_lift = "\nUpon a closer look you see that the door to the control room is open and you spot a keyhole.\nOut of the corner of your eye you spot a shadow looming inside the control room."
s_lodge ="\nStopping right before the parking lot, you enter an old ski lodge."
e_lodge = "\nOnce inside you see cans of food and mice scurrying around. Trays and utensils are strewn everywhere, as if people left in a hurry. \nGrabbing some of the untouched cans of food, you continue on skis down towards the parking lot."
s_lot = "\nYou kick off your skis. Running through the parking lot, you glance around seeing how some of the cars are ensnared by vines. One even has a tree going through it.\nYou begin to wonder not where you are but how long it has been."
e_lot = "\nFinally in the second to last row you find a car that stands alone and untouched. Getting in you flip down the visor and a key falls in your lap.\nTurning the key in the ignition the car miracously sputters to life."


mountain_npc = "\n" '\033[94m' "Welcome to the shadow realm weary traveler, my names Axel, to find the treasure that you seek,'\033[0m' '\033[1;3m'Polaris'\033[0m' '\033[94m'will start you on the correct path.\nLet it be known while a riddle will give you an escape, beware the chair."'\033[0m'
beach_npc = "\n" '\033[94m' "What\'s up dude!\nThe names Trevor, we are look at some radical waves today.\nSo surfs up dude, you got to ride the wave all the way out, cause everyone\'s surfing"'\033[0m'
ocean_npc = "\n" '\033[35m' "You are underwater why would there be anyone here"'\033[0m'
